...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 py-8">
      ...
      <div className="max-w-lg w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 z-10 border border-white/20">
        ...
        {isResettingPassword ? (
          ...
          <h1 className="text-2xl font-bold text-center text-gray-800 mb-4">{isLogin ? "Login" : "Create Account"}</h1>
        )}
        ...
        <form onSubmit={handleAuth} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200"
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-amber-500 to-orange-500 text-white py-2.5 rounded-lg hover:from-amber-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl font-semibold"
            disabled={loading}
          >
            {loading ? (
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-3 bg-white/95 text-gray-500">Or continue with</span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center bg-white border-2 border-gray-300 rounded-lg py-2.5 px-4 hover:bg-gray-50 hover:border-amber-500 transition-all duration-200 shadow-sm"
                  disabled={loading}
                >
