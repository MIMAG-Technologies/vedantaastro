      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2 ml-6">
            ...
            <p className="text-slate-800 mb-6 leading-relaxed max-w-md">
              Vedanta Astro offers personalized astrology, numerology, and Vedic solutions to guide you through life&lsquo;s challenges. Reach out for insights into your future and cosmic well-being.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919022755627" className="text-slate-800 hover:text-white transition-colors">
                  +91 902-275-5627
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-orange-500" />
                <a href="mailto:info@vedantaastro.com" className="text-slate-800 hover:text-white transition-colors">
          ...
          <div>
            ...
            <p className="text-slate-800 mb-4 text-sm">
              Don&lsquo;t miss our future updates! Get Subscribed Today!
            </p>
